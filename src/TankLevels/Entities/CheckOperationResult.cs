...
namespace TankLevels.Entities
{
    ...
    /// <summary>
    /// Struct representing a result for <see cref="ITank.CheckOperation" />.
    /// </summary>
    public struct CheckOperationResult : IEquatable<CheckOperationResult>
    {
        ...
        /// <summary>
        /// Initializes a new successful instance of the <see cref="CheckOperationResult" /> struct.
        /// </summary>
        /// <param name="startTime">The start time of the operation.</param>
        public CheckOperationResult(DateTime startTime)
            : this()
        {
            IsSuccess = true;
            StartTime = startTime;
        ...
        /// </summary>
        /// <value>True if this instance represents a successful check operation result.</value>
